(ns propagators-compound-profile
  ...
  (:require [propagators.infra.cells.cell :as cell :refer [construct-cell]]
            [propagators.infra.cells.diff :refer [diff-internal-output-cells]]
            ...
            [propagators.infra.core :as core :refer [run-tasks]]
            ...
            [propagators.infra.message :as m :refer [message-value]]
