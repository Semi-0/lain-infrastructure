...
### `propagators.infra.gur.accumulating.core`
...
### `propagators.infra.gur.accumulating.facts`
...
### `propagators.infra.gur.accumulating.ids`
...
### `propagators.infra.gur.accumulating.source`
...
### `propagators.infra.gur.accumulating.runner`
...
### `propagators.infra.gur.accumulating.runner.executor`
...
### `propagators.infra.gur.accumulating.runner.tasks`
...
### `propagators.infra.gur.accumulating.runner.instrumentation`
...
```clojure
(ns example
  (:require [propagators.infra.gur :as gur]))
...
That macro expands through `propagators.infra.gur.accumulating.source/def-recursive`.
...
The implementation in `propagators.infra.gur.accumulating/p:apply-closure` is:
