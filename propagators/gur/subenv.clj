...
(def fib-definition examples/fib-definition)
(def fib-closure examples/fib-closure)
(def factorial-definition examples/factorial-definition)
(def factorial-closure examples/factorial-closure)
(def int-sqrt-search-definition examples/int-sqrt-search-definition)
...
(def map-list-definition examples/map-list-definition)
(def map-list-closure examples/map-list-closure)
(def map-list-fib-definition examples/map-list-fib-definition)
(def map-list-fib-closure examples/map-list-fib-closure)
(def reduce-list-definition examples/reduce-list-definition)
(def reduce-list-closure examples/reduce-list-closure)
(def prefix-reduce-list-definition examples/prefix-reduce-list-definition)
(def prefix-reduce-list-closure examples/prefix-reduce-list-closure)
(def filter-list-definition examples/filter-list-definition)
