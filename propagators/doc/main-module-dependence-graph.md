...
| Compiler 2 | `compiler_2/compiler/core.clj`, `compiler_2/runtime/application.clj`, `compiler_common/cps.clj` | compound object, activation-local runtime, minimum runtime | Current compiler retains IR and slot-backed closure/application data, but application lowering still owns its own activation logic. |
