(ns propagators.infra.network-test
  (:require [clojure.test :refer [deftest is testing]]
            [propagators.infra.cells.cell :as cell :refer [construct-cell]]
            [propagators.infra.cells.diff :as diff]
            [propagators.infra.cells.value :refer [cell-value-equal?]]
            [propagators.infra.compile :as compile]
            [propagators.infra.compile :refer [cell-ref compile-net prop-ref]]
            [propagators.infra.graph :as graph :refer [node-input-ids node-output-ids]]
            [propagators.infra.message :as m]
            [propagators.infra.propagator :refer [compound-propagator prop?]]
            [propagators.infra.core :refer [run-tasks]]
            [propagators.infra.helpers.task-queue :as tq]
            [propagators.infra.ids :refer [new-node-id]]
            [propagators.infra.network :as net]
            [propagators.infra.stdlib.boundary :refer [bi-sync-closure]]
            [propagators.infra.stdlib.prop :refer [id]]))
