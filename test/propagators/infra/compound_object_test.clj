(ns propagators.infra.compound-object-test
  ...
  (:require [clojure.test :refer [deftest is testing]]
            ...
            [propagators.infra.deprecated.compound-data :as linked]
