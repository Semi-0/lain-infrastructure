(ns propagators.infra.compound-data-test
  "Linked-list compound_data: p:car, p:cdr, c:linked-list.
  Run: clj -M:test propagators.infra.compound-data-test"
  (:require [clojure.test :refer [deftest is testing]]
            [propagators.infra.cells.avatar :as avatar]
            ...
            [propagators.infra.deprecated.compound-data :as cd]
