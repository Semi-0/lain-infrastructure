(ns propagators.infra.compound-diagnosis-test
  "Proof tests for compound inner scheduling (avatar boundaries).
  Run: clj -M:test propagators.infra.compound-diagnosis-test"
  (:require [clojure.test :refer [deftest is testing]]
            ...
            [propagators.infra.propagator :refer [compound-propagator]]
