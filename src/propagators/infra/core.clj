(ns propagators.infra.core
  ...
  (:require [propagators.infra.cells.cell :as cell]
            ...
            [propagators.infra.message :refer [message-id message-value]]
...
(defn- maybe-register-subenv
  [n id strongest]
  (let [register (requiring-resolve 'propagators.infra.gur.subenv/maybe-register-subenv)]
...
(defn eval-cell*
  ...
  "
  [directory msg n]
  (let [dispatch-eval (requiring-resolve 'propagators.infra.gur.subenv/eval-cell*)]
