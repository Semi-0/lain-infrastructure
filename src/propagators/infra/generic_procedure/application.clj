(ns propagators.infra.generic-procedure.application
  (:require [propagators.infra.application :as application]
            [propagators.infra.cells.value :as value]
            [propagators.infra.datastructures.compound-object :as obj]
            [propagators.infra.dispatch :as dispatch]
            [propagators.infra.generic-procedure.constants :as constants]
            [propagators.infra.generic-procedure.materialize :as materialize]
            [propagators.infra.generic-procedure.methods :as methods]
            ...
            [propagators.infra.network-cache :as cache]
