(ns propagators.infra.closure
  (:require [propagators.infra.boundary :as boundary]
            ...
            [propagators.infra.network :refer [network-cell-strongest
...
(defn p:apply-network
  ...
  does not run the expanded network or install it into the outer propagators.tui.graph."
