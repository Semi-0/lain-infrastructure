(ns propagators.infra.gur.subenv.source
  "Source-level DSL helpers for lexical sub-env GUR."
  (:require [propagators.infra.compile :as compile]
...
(defmacro def-recursive
  ...
  This macro keeps the same option shape as `propagators.infra.compile/def-recursive`
