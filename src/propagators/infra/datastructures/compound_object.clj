(ns propagators.infra.datastructures.compound-object
  "Public facade for compound-object slots, reducers, and sequence helpers."
  (:require [propagators.infra.datastructures.compound-object.core :as core]
            [propagators.infra.datastructures.compound-object.cursor :as cursor]
            [propagators.infra.datastructures.compound-object.map :as map]
            [propagators.infra.datastructures.compound-object.merge :as compound-merge]
            [propagators.infra.datastructures.compound-object.network-slot :as network-slot]
            [propagators.infra.datastructures.compound-object.reduce :as reduce]
            [propagators.infra.datastructures.compound-object.sequence :as sequence]
            [propagators.infra.datastructures.compound-object.slot :as slot]))
