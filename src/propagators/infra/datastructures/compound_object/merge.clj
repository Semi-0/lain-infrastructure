(ns propagators.infra.datastructures.compound-object.merge
  ...
  (:require [propagators.infra.cells.cell :as cell]
            ...
            [propagators.infra.datastructures.compound-object.core :as core]
...
(defn- behavior-value?
  ...
  (boolean
   (when-let [behavior-value? (requiring-resolve
                               'propagators.infra.datastructures.behavior/behavior-value?)]
     (behavior-value? v))))

(defn- merge-behavior
  [a b]
  ((requiring-resolve 'propagators.infra.datastructures.behavior/merge-content) a b))
