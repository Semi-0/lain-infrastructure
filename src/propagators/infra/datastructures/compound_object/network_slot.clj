(ns propagators.infra.datastructures.compound-object.network-slot
  ...
  (:require [propagators.infra.cells.cell :as cell]
            ...
            [propagators.infra.effectful-execution :as effect]
            [propagators.infra.effectful-sync :as sync]
            ...
            [propagators.infra.scoped-address :as scoped]))
     ...
     (if-not (contains? (net/net-env parent-net) parent-id)
       ...
       (let [n0 (compound-merge/ensure-accessor-avatar n slot-key parent-id)
             ...
             merge-cell-entry (requiring-resolve
                               'propagators.infra.cells.merge/merge-cell-entry)]
         (net/assoc-net-cell
          n0
          avatar-id
