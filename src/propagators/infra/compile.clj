(ns propagators.infra.compile
  "Compatibility facade for the primitive compiler.

  New implementation code lives under `propagators.infra.primitive-compiler.*`.
  Existing callers can keep requiring `propagators.infra.compile`."
  (:require [propagators.infra.primitive-compiler.core :as pc]
            [propagators.infra.primitive-compiler.eval :as eval]
            [propagators.infra.primitive-compiler.installers :as installers]
            [propagators.infra.primitive-compiler.recursive :as recursive]
            [propagators.infra.primitive-compiler.runtime :as runtime]))
