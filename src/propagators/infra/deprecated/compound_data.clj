(ns propagators.infra.deprecated.compound-data
  "Deprecated linked-list propagators over compound subnet cells.

  Prefer propagators.infra.datastructures.compound-object for new compound slot work.
  This namespace is kept as the old linked-list dispatcher spike."
  (:require [propagators.infra.datastructures.compound_strongest_result :as strongest]
