(ns propagators.infra.cells.cell
...
(defn construct-cell
  ...
  ([id]
   (fn [arg]
     (let [as-net (requiring-resolve 'propagators.infra.network/as-net)
           assoc-net-node (requiring-resolve 'propagators.infra.network/assoc-net-node)
           assoc-net-cell (requiring-resolve 'propagators.infra.network/assoc-net-cell)
           blank-node (requiring-resolve 'propagators.infra.graph/blank-node)
           net (as-net arg)
           n (-> net
