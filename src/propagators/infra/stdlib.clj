(ns ^{:deprecated "Import propagators.infra.stdlib.prop, .boundary, .effect, .layered, or .arithmetic.* directly."}
  propagators.infra.stdlib
  "Deprecated barrel. Use leaf namespaces under `propagators.infra.stdlib.*`."
  (:require [propagators.infra.stdlib.arithmetic.provenance :as provenance]
            [propagators.infra.stdlib.boundary :as boundary]
            [propagators.infra.stdlib.effect :as effect]
            [propagators.infra.stdlib.prop :as prop]))
