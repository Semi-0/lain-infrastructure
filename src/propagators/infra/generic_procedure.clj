(ns propagators.infra.generic-procedure
  ...
  (:require [propagators.infra.generic-procedure.application :as application]
            [propagators.infra.generic-procedure.define :as define]
            [propagators.infra.generic-procedure.match :as match]
