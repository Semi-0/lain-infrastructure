(ns propagators.infra.application
  "Shared application combinators for procedure-like propagators.infra."
  (:require [propagators.infra.cells.diff :as diff]
...
(defn- report-trace!
  ...
  (when trace
    (when-let [report! (requiring-resolve
                        'propagators.infra.application-debugger/report!)]
