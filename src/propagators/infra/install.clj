(ns propagators.infra.install
  ...
  propagation to `propagators.infra.core`."
  (:refer-clojure :exclude [+ - * / <= not and or when cons])
  (:require [clojure.core :as c]
            [propagators.infra.core :as kernel]
            ...
            [propagators.infra.propagator :as p]
            [propagators.infra.stdlib.prop :as prop]))

(def cell-bindings-scope-tag :propagators.infra.install/cells)
