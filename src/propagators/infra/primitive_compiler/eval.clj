(ns propagators.infra.primitive-compiler.eval
  (:refer-clojure :exclude [eval])
  (:require [propagators.infra.network :as net]
            [propagators.infra.network-builder :as nb]
            [propagators.infra.primitive-compiler.core :as pc]
...
(defn eval-layered
  ...
  This is intentionally installer-driven rather than tied to `propagators.infra.layered`,
